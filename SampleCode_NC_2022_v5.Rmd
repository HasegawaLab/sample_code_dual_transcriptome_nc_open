---
title: "Integrated relationship of nasopharyngeal airway host response and microbiome"
  with bronchiolitis severity :dual-transcriptomic profiling
author: Michimasa Fujiogi; Yoshihiko Raita; Marcos Pérez-Losada; Robert J. Freishtat,;
  Juan C. Celedón; Jonathan M. Mansbach; Pedro A. Piedra; Zhaozhong Zhu; Carlos A.
  Camargo, Jr.; and Kohei Hasegawa
date: "3/12/2022"
output:
...
STEP B) Reduce the dimensions of the host response, microbial composition, and microbial function data for the subsequent integrated analyses.
...
STEP C) Determine the integrated relationships of these dual-transcriptome modules with outcomes
...
Reference: Wang DD, Nguyen LH, Li Y, et al. The gut microbiome modulates the protective association between a Mediterranean diet and cardiometabolic disease risk. Nat Med. 2021;27(2):333-343. doi:10.1038/s41591-020-01223-3
B)　Pirate plots of top 10
```{r}
# Load data
df_fig3B <-  read.csv("data_object_fig3B.csv", header=TRUE)
...
```{r}
#load dataset
df_figS4A <- read.csv("data_object_figS4A.csv")
...
#Microbiome function
loglogplot_function <- read.csv("data_object_figS9_MF.csv")
